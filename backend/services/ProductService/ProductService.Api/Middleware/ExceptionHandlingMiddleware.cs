...
/// <summary>Maps domain/validation exceptions to the HTTP status codes documented in contracts/product-service.openapi.yaml
/// (400 validation, 404 not found, 409 conflict) so handlers never need to know about HTTP.</summary>
