...
/// the domain change that raised it, then relayed to the bus by OutboxDispatcherHostedService — guaranteeing
/// the event is never lost even if the process crashes right after commit.</summary>
